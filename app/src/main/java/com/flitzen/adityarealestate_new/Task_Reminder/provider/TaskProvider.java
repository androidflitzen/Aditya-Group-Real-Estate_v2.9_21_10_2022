package com.flitzen.adityarealestate_new.Task_Reminder.provider;
...
public class TaskProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.flitzen.adityarealestate_new.Task_Reminder.provider.TaskProvider";
